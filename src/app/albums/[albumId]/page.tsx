...
export default function AlbumPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--cream)" }}>
      ...
      <FaceProcessor photos={album.ceremonies.flatMap((ceremony) => ceremony.photos.map((photo) => ({ id: photo.id, url: FACE_CONFIG.scanSource === "original" && photo.originalUrl ? photo.originalUrl : photo.url, faceProcessed: Boolean(photo.faceProcessed) })))} />
